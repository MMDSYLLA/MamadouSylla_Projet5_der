"use script"
// fonction qui traite les inforamtions reçues par la requête 'http://127.0.0.1:3000/api/products'
function dataProcessing(tab_canapes){
...
for (let x=0;  x <= tab_canapes.length-1; x++ ) {
  ...
  a.setAttribute("href", "./product.html?id="+tab_canapes[x]['_id']); 
